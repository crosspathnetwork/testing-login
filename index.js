...
async function main() {
  ...
  await page.type("xpath//html/body/div/div/main/div[1]/div/input", firstName);
  //Second name
  await page.click("xpath//html/body/div/div/main/div[2]");
  await page.type("xpath//html/body/div/div/main/div[2]/div/input", middleName);
  //Email
  ...
  console.log("sector passed ");
   ...
   await chooseTest("https://becrosspath.com/hub/positions","Position.csv", 5);
  ...
  await page.click("button.btn.bg.primary");
   ...
   await chooseTest("https://becrosspath.com/hub/skills/hard","HardSkill.csv", 10);
  ...
  await page.waitForResponse(
    response =>
      //console.log(response.url())
       response.url() === "https://becrosspath.com/hub/locations" && response.status() === 200
  );
  ...
  await page.click("button.btn.bg.primary");
   ...
   await chooseTest("https://becrosspath.com/hub/languages","Language.csv", 5);
   console.log("Languange passed");
  ...
  await chooseTest("https://becrosspath.com/hub/seniorities","Seniority.csv", 1);
